	...
	try:
		if (status != '0');
			if (message.text == "Личный кабинет"):
				...
				receive 	= database.user_recevies(chat_id)
				...
				inline_kevboard.add(inline_1, inline_2, inline_3, inline_4)
...
def answer(call):
	...
	try:
		if (call.data == 'PROMOCODE'):
			...
			message = bot.send_message(chat_id, f'💁🏻‍♀️ Введите *свой* QIWI кошелек\nВо избежении мошенничества вывод разрешён только на те QIWI, с которых поступало пополнение!', parse_mode="Markdown")
